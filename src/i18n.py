...
snakeInstruction = {'ger': ['Kurzanleitung',
                            'Zum Start Enter oder Pfeiltaste drücken!',
                    ...
                    'eng': ['Instructions',
                            'Press return or arrow key to start!',
                            'You are awarded one point per beer per caught fox',
                            'Beer makes you swift and successful.',
                            'But take care, too much of it complicates your mission!'],
                    'bay': ['Afgom',
                            'Druck af Enter oda an Pfeil zum Spuin!',
